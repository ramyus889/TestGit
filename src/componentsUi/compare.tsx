"use client";
import { useCompare } from "@/app/Compare/useCompare";
import { SparklesCore } from "@/componentsUi/sparkles";
    ...
    >
      ...
      <AnimatePresence initial={false}>
        {secondImage ? (
          <motion.img
            className={cn(
              `absolute left-0 top-0 z-[19]  h-full w-full select-none rounded-2xl hue-rotate-[${random}deg]`,
              secondImageClassname,
            )}
            alt="second image"
            src={secondImage}
